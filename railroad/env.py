"""
JT = {1:"東京", 2:"新橋", 3:"品川"}
JO = {16:"西大井", 17:"品川", 18:"新橋", 19:"東京", 20:"新日本橋", 21:"馬喰町", 22:"錦糸町", 23:"新小岩"}
...
railroad_list = ["埼京線(浮間舟渡-大崎)", "埼京線(りんかい線直通)", "埼京線(相鉄線直通)", "りんかい線", "総武線各停・中央線各停", "中央線快速(快速)", "中央線快速(通勤快速)", "中央線快速(中央・青海特快)", "中央線快速(通勤特快)", "京葉線(各駅停車)", "京葉線(快速・通勤快速)", "京浜東北線(各駅停車)", "京浜東北線(快速)", "横須賀線・総武線快速", "湘南新宿ライン(宇都宮線・横須賀線直通)(普通・快速)", "湘南新宿ライン(高崎線・東海道線直通)(普通・快速)", "湘南新宿ライン(高崎線・東海道線直通)(特別快速)", "常磐線各駅停車", "常磐線快速(上野-北千住)(普通・快速)", "常磐線快速(上野-北千住)(特別快速)", "山手線"]
bound_list = ["外回り", "内回り", "中央線快速 下り方面", "京葉線 下り方面", "新小岩・小岩 以東", "北千住 以東(常磐線快速)", "金町以東(常磐線各停)", "西荻窪 以西", "北千住 以西(常磐線各停)", "西大井 以南", "蒲田 以南", "赤羽 以北(埼京線以外)", "浮間舟渡 以北", "大崎", "新宿", "池袋", "赤羽", "東十条", "上野", "東京", "品川", "御茶ノ水", "中野", "綾瀬", "新木場", "東京テレポート"]