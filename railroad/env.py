...
railroad_list = ["総武線各停・中央線各停", "中央線快速", "中央線(通勤快速)", "中央線(中央・青海特快)", "中央線(通勤特快)", "京葉線(各駅停車)", "京葉線(快速・通勤快速)", "京浜東北線(各駅停車)", "京浜東北線(快速)", "湘南新宿ライン(宇都宮線・横須賀線直通)(普通・快速)", "湘南新宿ライン(高崎線・東海道線直通)(普通・快速)", "湘南新宿ライン(高崎線・東海道線直通)(特別快速)", "山手線"]
