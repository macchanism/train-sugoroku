...
railroad_list = ["総武線(各駅停車)", "中央線(快速)", "中央線(通勤快速)", "中央線(中央・青海特快)", "中央線(通勤特快)", "京葉線(各駅停車)", "京葉線(快速・通勤快速)", "京浜東北線(各駅停車)", "京浜東北線(快速)", "山手線"]
bound_list = ["西荻窪 以西", "中野", "御茶ノ水", "新小岩・小岩 以東", "中央線快速 下り方面", "京葉線 下り方面", "赤羽 以北", "東十条", "上野", "東京", "品川", "蒲田 以南", "外回り", "内回り"]
